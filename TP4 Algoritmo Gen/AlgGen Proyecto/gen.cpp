...
void Gen::ordenarPorAptitud2(){ //para fines de prueba
    Individuo * temp;
    for(int i=0; i<100; i++){
        for(int j=0; j<99; j++){
...
void Gen::calcularAptitud(Individuo * ind,int valorIndividuo, int valorReal){//tiene que adaptarse al problema a solucionar
